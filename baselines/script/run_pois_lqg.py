...
def main():
    ...
    parser.add_argument('--ess', type=str, default='renyi')
    args = parser.parse_args()
    if args.file_name == 'progress':
        file_name = 'pois_lqg_iw_method=%s_iw_norm=%s_natural=%s_bound=%s_ess=%s_%s' % (args.iw_method, args.iw_norm, args.natural, args.bound, args.ess, time.time())
    else:
